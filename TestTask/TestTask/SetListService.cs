...
namespace TestTask
{
    public static class SetListService
    {
		public static async void SetListAsync(ListView list)
		{
			IList<Offer> offers = new List<Offer>();
			Task<Yml_catalog> task = GetAsync<Yml_catalog>("http://partner.market.yandex.ru/pages/help/YML.xml");
